...
public class ClapFilter implements SampleProvider {
	 ...
	 * sufficiently far in the past that a first clap is always returned. The
	 * soundMode argument must be a sample provider of an NXTSoundSensor
	 *
	 ...
	 */
	public ClapFilter(SampleProvider soundMode, float level, int gap) {
		timeGap = gap;
		ss = soundMode;
		threshold = level;
	 ...
	 * returned is 0 for no clap , and 1 for a clap .
	 *
